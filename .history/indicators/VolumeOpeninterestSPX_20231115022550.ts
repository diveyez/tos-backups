# open_interest_vertical_axis_manual_spx_v2
# This version adds labels at the end of the bars  
# Also automatically selects the correct option series based on the current date
# Twitter @2187Nick
declare upper;
declare once_per_bar;
def CurrentYear = GetYear(); # - 2020
...
input space = 1.00; # the vertical space between the put open interest bar and call open interest bar.
    ...
    DefineGlobalColor("CallColor", Color.YELLOW);
DefineGlobalColor("PutColor", Color.MAGENTA);
...
def putOptionopen_interest = if IsNaN(open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "P")) else Concat(CurrentDOM, "P")) + AsPrice(PutStrike - strikeSpacing * 0), agg)) then 0 else open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "P")) else Concat(CurrentDOM, "P")) + AsPrice(PutStrike - strikeSpacing * 0), agg);
def putOptionopen_interest1 = if IsNaN(open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "P")) else Concat(CurrentDOM, "P")) + AsPrice(PutStrike - strikeSpacing * 1), agg)) then 0 else open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "P")) else Concat(CurrentDOM, "P")) + AsPrice(PutStrike - strikeSpacing * 1), agg);
def putOptionopen_interest2 = if IsNaN(open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "P")) else Concat(CurrentDOM, "P")) + AsPrice(PutStrike - strikeSpacing * 2), agg)) then 0 else open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "P")) else Concat(CurrentDOM, "P")) + AsPrice(PutStrike - strikeSpacing * 2), agg);
def putOptionopen_interest3 = if IsNaN(open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "P")) else Concat(CurrentDOM, "P")) + AsPrice(PutStrike - strikeSpacing * 3), agg)) then 0 else open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "P")) else Concat(CurrentDOM, "P")) + AsPrice(PutStrike - strikeSpacing * 3), agg);
def putOptionopen_interest4 = if IsNaN(open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "P")) else Concat(CurrentDOM, "P")) + AsPrice(PutStrike - strikeSpacing * 4), agg)) then 0 else open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "P")) else Concat(CurrentDOM, "P")) + AsPrice(PutStrike - strikeSpacing * 4), agg);
def putOptionopen_interest5 = if IsNaN(open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "P")) else Concat(CurrentDOM, "P")) + AsPrice(PutStrike - strikeSpacing * 5), agg)) then 0 else open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "P")) else Concat(CurrentDOM, "P")) + AsPrice(PutStrike - strikeSpacing * 5), agg);
def putOptionopen_interest6 = if IsNaN(open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "P")) else Concat(CurrentDOM, "P")) + AsPrice(PutStrike - strikeSpacing * 6), agg)) then 0 else open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "P")) else Concat(CurrentDOM, "P")) + AsPrice(PutStrike - strikeSpacing * 6), agg);
def putOptionopen_interest7 = if IsNaN(open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "P")) else Concat(CurrentDOM, "P")) + AsPrice(PutStrike - strikeSpacing * 7), agg)) then 0 else open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "P")) else Concat(CurrentDOM, "P")) + AsPrice(PutStrike - strikeSpacing * 7), agg);
def putOptionopen_interest8 = if IsNaN(open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "P")) else Concat(CurrentDOM, "P")) + AsPrice(PutStrike - strikeSpacing * 8), agg)) then 0 else open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "P")) else Concat(CurrentDOM, "P")) + AsPrice(PutStrike - strikeSpacing * 8), agg);
def putOptionopen_interest9 = if IsNaN(open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "P")) else Concat(CurrentDOM, "P")) + AsPrice(PutStrike - strikeSpacing * 9), agg)) then 0 else open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "P")) else Concat(CurrentDOM, "P")) + AsPrice(PutStrike - strikeSpacing * 9), agg);
def putOptionopen_interest10 = if IsNaN(open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "P")) else Concat(CurrentDOM, "P")) + AsPrice(PutStrike - strikeSpacing * 10), agg)) then 0 else open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "P")) else Concat(CurrentDOM, "P")) + AsPrice(PutStrike - strikeSpacing * 10), agg);
def putOptionopen_interest11 = if IsNaN(open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "P")) else Concat(CurrentDOM, "P")) + AsPrice(PutStrike - strikeSpacing * 11), agg)) then 0 else open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "P")) else Concat(CurrentDOM, "P")) + AsPrice(PutStrike - strikeSpacing * 11), agg);
def putOptionopen_interest13 = if IsNaN(open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "P")) else Concat(CurrentDOM, "P")) + AsPrice(PutStrike - strikeSpacing * 12), agg)) then 0 else open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "P")) else Concat(CurrentDOM, "P")) + AsPrice(PutStrike - strikeSpacing * 12), agg);
def putOptionopen_interest12 = if IsNaN(open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "P")) else Concat(CurrentDOM, "P")) + AsPrice(PutStrike - strikeSpacing * 13), agg)) then 0 else open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "P")) else Concat(CurrentDOM, "P")) + AsPrice(PutStrike - strikeSpacing * 13), agg);
def putOptionopen_interest14 = if IsNaN(open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "P")) else Concat(CurrentDOM, "P")) + AsPrice(PutStrike - strikeSpacing * 14), agg)) then 0 else open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "P")) else Concat(CurrentDOM, "P")) + AsPrice(PutStrike - strikeSpacing * 14), agg);
def putOptionopen_interest15 = if IsNaN(open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "P")) else Concat(CurrentDOM, "P")) + AsPrice(PutStrike - strikeSpacing * 15), agg)) then 0 else open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "P")) else Concat(CurrentDOM, "P")) + AsPrice(PutStrike - strikeSpacing * 15), agg);
def putOptionopen_interest16 = if IsNaN(open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "P")) else Concat(CurrentDOM, "P")) + AsPrice(PutStrike - strikeSpacing * 16), agg)) then 0 else open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "P")) else Concat(CurrentDOM, "P")) + AsPrice(PutStrike - strikeSpacing * 16), agg);
def putOptionopen_interest17 = if IsNaN(open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "P")) else Concat(CurrentDOM, "P")) + AsPrice(PutStrike - strikeSpacing * 17), agg)) then 0 else open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "P")) else Concat(CurrentDOM, "P")) + AsPrice(PutStrike - strikeSpacing * 17), agg);
def putOptionopen_interest18 = if IsNaN(open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "P")) else Concat(CurrentDOM, "P")) + AsPrice(PutStrike - strikeSpacing * 18), agg)) then 0 else open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "P")) else Concat(CurrentDOM, "P")) + AsPrice(PutStrike - strikeSpacing * 18), agg);
def putOptionopen_interest19 = if IsNaN(open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "P")) else Concat(CurrentDOM, "P")) + AsPrice(PutStrike - strikeSpacing * 19), agg)) then 0 else open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "P")) else Concat(CurrentDOM, "P")) + AsPrice(PutStrike - strikeSpacing * 19), agg);
def putOptionopen_interest20 = if IsNaN(open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "P")) else Concat(CurrentDOM, "P")) + AsPrice(PutStrike - strikeSpacing * 20), agg)) then 0 else open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "P")) else Concat(CurrentDOM, "P")) + AsPrice(PutStrike - strikeSpacing * 20), agg);

def putOptionopen_interesta = if IsNaN(open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "P")) else Concat(CurrentDOM, "P")) + AsPrice(PutStrike + strikeSpacing * 0), agg)) then 0 else open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "P")) else Concat(CurrentDOM, "P")) + AsPrice(PutStrike + strikeSpacing * 0), agg);
def putOptionopen_interest1a = if IsNaN(open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "P")) else Concat(CurrentDOM, "P")) + AsPrice(PutStrike + strikeSpacing * 1), agg)) then 0 else open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "P")) else Concat(CurrentDOM, "P")) + AsPrice(PutStrike + strikeSpacing * 1), agg);
def putOptionopen_interest2a = if IsNaN(open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "P")) else Concat(CurrentDOM, "P")) + AsPrice(PutStrike + strikeSpacing * 2), agg)) then 0 else open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "P")) else Concat(CurrentDOM, "P")) + AsPrice(PutStrike + strikeSpacing * 2), agg);
def putOptionopen_interest3a = if IsNaN(open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "P")) else Concat(CurrentDOM, "P")) + AsPrice(PutStrike + strikeSpacing * 3), agg)) then 0 else open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "P")) else Concat(CurrentDOM, "P")) + AsPrice(PutStrike + strikeSpacing * 3), agg);
def putOptionopen_interest4a = if IsNaN(open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "P")) else Concat(CurrentDOM, "P")) + AsPrice(PutStrike + strikeSpacing * 4), agg)) then 0 else open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "P")) else Concat(CurrentDOM, "P")) + AsPrice(PutStrike + strikeSpacing * 4), agg);
def putOptionopen_interest5a = if IsNaN(open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "P")) else Concat(CurrentDOM, "P")) + AsPrice(PutStrike + strikeSpacing * 5), agg)) then 0 else open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "P")) else Concat(CurrentDOM, "P")) + AsPrice(PutStrike + strikeSpacing * 5), agg);
def putOptionopen_interest6a = if IsNaN(open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "P")) else Concat(CurrentDOM, "P")) + AsPrice(PutStrike + strikeSpacing * 6), agg)) then 0 else open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "P")) else Concat(CurrentDOM, "P")) + AsPrice(PutStrike + strikeSpacing * 6), agg);
def putOptionopen_interest7a = if IsNaN(open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "P")) else Concat(CurrentDOM, "P")) + AsPrice(PutStrike + strikeSpacing * 7), agg)) then 0 else open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "P")) else Concat(CurrentDOM, "P")) + AsPrice(PutStrike + strikeSpacing * 7), agg);
def putOptionopen_interest8a = if IsNaN(open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "P")) else Concat(CurrentDOM, "P")) + AsPrice(PutStrike + strikeSpacing * 8), agg)) then 0 else open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "P")) else Concat(CurrentDOM, "P")) + AsPrice(PutStrike + strikeSpacing * 8), agg);
def putOptionopen_interest9a = if IsNaN(open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "P")) else Concat(CurrentDOM, "P")) + AsPrice(PutStrike + strikeSpacing * 9), agg)) then 0 else open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "P")) else Concat(CurrentDOM, "P")) + AsPrice(PutStrike + strikeSpacing * 9), agg);
def putOptionopen_interest10a = if IsNaN(open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "P")) else Concat(CurrentDOM, "P")) + AsPrice(PutStrike + strikeSpacing * 10), agg)) then 0 else open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "P")) else Concat(CurrentDOM, "P")) + AsPrice(PutStrike + strikeSpacing * 10), agg);
def putOptionopen_interest11a = if IsNaN(open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "P")) else Concat(CurrentDOM, "P")) + AsPrice(PutStrike + strikeSpacing * 11), agg)) then 0 else open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "P")) else Concat(CurrentDOM, "P")) + AsPrice(PutStrike + strikeSpacing * 11), agg);
def putOptionopen_interest13a = if IsNaN(open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "P")) else Concat(CurrentDOM, "P")) + AsPrice(PutStrike + strikeSpacing * 12), agg)) then 0 else open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "P")) else Concat(CurrentDOM, "P")) + AsPrice(PutStrike + strikeSpacing * 12), agg);
def putOptionopen_interest12a = if IsNaN(open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "P")) else Concat(CurrentDOM, "P")) + AsPrice(PutStrike + strikeSpacing * 13), agg)) then 0 else open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "P")) else Concat(CurrentDOM, "P")) + AsPrice(PutStrike + strikeSpacing * 13), agg);
def putOptionopen_interest14a = if IsNaN(open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "P")) else Concat(CurrentDOM, "P")) + AsPrice(PutStrike + strikeSpacing * 14), agg)) then 0 else open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "P")) else Concat(CurrentDOM, "P")) + AsPrice(PutStrike + strikeSpacing * 14), agg);
def putOptionopen_interest15a = if IsNaN(open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "P")) else Concat(CurrentDOM, "P")) + AsPrice(PutStrike + strikeSpacing * 15), agg)) then 0 else open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "P")) else Concat(CurrentDOM, "P")) + AsPrice(PutStrike + strikeSpacing * 15), agg);
def putOptionopen_interest16a = if IsNaN(open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "P")) else Concat(CurrentDOM, "P")) + AsPrice(PutStrike + strikeSpacing * 16), agg)) then 0 else open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "P")) else Concat(CurrentDOM, "P")) + AsPrice(PutStrike + strikeSpacing * 16), agg);
def putOptionopen_interest17a = if IsNaN(open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "P")) else Concat(CurrentDOM, "P")) + AsPrice(PutStrike + strikeSpacing * 17), agg)) then 0 else open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "P")) else Concat(CurrentDOM, "P")) + AsPrice(PutStrike + strikeSpacing * 17), agg);
def putOptionopen_interest18a = if IsNaN(open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "P")) else Concat(CurrentDOM, "P")) + AsPrice(PutStrike + strikeSpacing * 18), agg)) then 0 else open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "P")) else Concat(CurrentDOM, "P")) + AsPrice(PutStrike + strikeSpacing * 18), agg);
def putOptionopen_interest19a = if IsNaN(open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "P")) else Concat(CurrentDOM, "P")) + AsPrice(PutStrike + strikeSpacing * 19), agg)) then 0 else open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "P")) else Concat(CurrentDOM, "P")) + AsPrice(PutStrike + strikeSpacing * 19), agg);
def putOptionopen_interest20a = if IsNaN(open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "P")) else Concat(CurrentDOM, "P")) + AsPrice(PutStrike + strikeSpacing * 20), agg)) then 0 else open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "P")) else Concat(CurrentDOM, "P")) + AsPrice(PutStrike + strikeSpacing * 20), agg);

###Call Option open_interest
def callOptionopen_interest = if IsNaN(open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "C")) else Concat(CurrentDOM, "C")) + AsPrice(CallStrike + strikeSpacing * 0), agg)) then 0 else open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "C")) else Concat(CurrentDOM, "C")) + AsPrice(CallStrike + strikeSpacing * 0), agg);

def callOptionopen_interest1 = if IsNaN(open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "C")) else Concat(CurrentDOM, "C")) + AsPrice(CallStrike + strikeSpacing * 1), agg)) then 0 else open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "C")) else Concat(CurrentDOM, "C")) + AsPrice(CallStrike + strikeSpacing * 1), agg);
def callOptionopen_interest2 = if IsNaN(open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "C")) else Concat(CurrentDOM, "C")) + AsPrice(CallStrike + strikeSpacing * 2), agg)) then 0 else open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "C")) else Concat(CurrentDOM, "C")) + AsPrice(CallStrike + strikeSpacing * 2), agg);
def callOptionopen_interest3 = if IsNaN(open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "C")) else Concat(CurrentDOM, "C")) + AsPrice(CallStrike + strikeSpacing * 3), agg)) then 0 else open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "C")) else Concat(CurrentDOM, "C")) + AsPrice(CallStrike + strikeSpacing * 3), agg);
def callOptionopen_interest4 = if IsNaN(open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "C")) else Concat(CurrentDOM, "C")) + AsPrice(CallStrike + strikeSpacing * 4), agg)) then 0 else open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "C")) else Concat(CurrentDOM, "C")) + AsPrice(CallStrike + strikeSpacing * 4), agg);
def callOptionopen_interest5 = if IsNaN(open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "C")) else Concat(CurrentDOM, "C")) + AsPrice(CallStrike + strikeSpacing * 5), agg)) then 0 else open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "C")) else Concat(CurrentDOM, "C")) + AsPrice(CallStrike + strikeSpacing * 5), agg);
def callOptionopen_interest6 = if IsNaN(open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "C")) else Concat(CurrentDOM, "C")) + AsPrice(CallStrike + strikeSpacing * 6), agg)) then 0 else open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "C")) else Concat(CurrentDOM, "C")) + AsPrice(CallStrike + strikeSpacing * 6), agg);
def callOptionopen_interest7 = if IsNaN(open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "C")) else Concat(CurrentDOM, "C")) + AsPrice(CallStrike + strikeSpacing * 7), agg)) then 0 else open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "C")) else Concat(CurrentDOM, "C")) + AsPrice(CallStrike + strikeSpacing * 7), agg);
def callOptionopen_interest8 = if IsNaN(open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "C")) else Concat(CurrentDOM, "C")) + AsPrice(CallStrike + strikeSpacing * 8), agg)) then 0 else open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "C")) else Concat(CurrentDOM, "C")) + AsPrice(CallStrike + strikeSpacing * 8), agg);
def callOptionopen_interest9 = if IsNaN(open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "C")) else Concat(CurrentDOM, "C")) + AsPrice(CallStrike + strikeSpacing * 9), agg)) then 0 else open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "C")) else Concat(CurrentDOM, "C")) + AsPrice(CallStrike + strikeSpacing * 9), agg);
def callOptionopen_interest10 = if IsNaN(open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "C")) else Concat(CurrentDOM, "C")) + AsPrice(CallStrike + strikeSpacing * 10), agg)) then 0 else open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "C")) else Concat(CurrentDOM, "C")) + AsPrice(CallStrike + strikeSpacing * 10), agg);
def callOptionopen_interest11 = if IsNaN(open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "C")) else Concat(CurrentDOM, "C")) + AsPrice(CallStrike + strikeSpacing * 11), agg)) then 0 else open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "C")) else Concat(CurrentDOM, "C")) + AsPrice(CallStrike + strikeSpacing * 11), agg);
def callOptionopen_interest12 = if IsNaN(open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "C")) else Concat(CurrentDOM, "C")) + AsPrice(CallStrike + strikeSpacing * 12), agg)) then 0 else open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "C")) else Concat(CurrentDOM, "C")) + AsPrice(CallStrike + strikeSpacing * 12), agg);
def callOptionopen_interest13 = if IsNaN(open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "C")) else Concat(CurrentDOM, "C")) + AsPrice(CallStrike + strikeSpacing * 13), agg)) then 0 else open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "C")) else Concat(CurrentDOM, "C")) + AsPrice(CallStrike + strikeSpacing * 13), agg);
def callOptionopen_interest14 = if IsNaN(open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "C")) else Concat(CurrentDOM, "C")) + AsPrice(CallStrike + strikeSpacing * 14), agg)) then 0 else open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "C")) else Concat(CurrentDOM, "C")) + AsPrice(CallStrike + strikeSpacing * 14), agg);
def callOptionopen_interest15 = if IsNaN(open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "C")) else Concat(CurrentDOM, "C")) + AsPrice(CallStrike + strikeSpacing * 15), agg)) then 0 else open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "C")) else Concat(CurrentDOM, "C")) + AsPrice(CallStrike + strikeSpacing * 15), agg);
def callOptionopen_interest16 = if IsNaN(open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "C")) else Concat(CurrentDOM, "C")) + AsPrice(CallStrike + strikeSpacing * 16), agg)) then 0 else open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "C")) else Concat(CurrentDOM, "C")) + AsPrice(CallStrike + strikeSpacing * 16), agg);
def callOptionopen_interest17 = if IsNaN(open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "C")) else Concat(CurrentDOM, "C")) + AsPrice(CallStrike + strikeSpacing * 17), agg)) then 0 else open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "C")) else Concat(CurrentDOM, "C")) + AsPrice(CallStrike + strikeSpacing * 17), agg);
def callOptionopen_interest18 = if IsNaN(open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "C")) else Concat(CurrentDOM, "C")) + AsPrice(CallStrike + strikeSpacing * 18), agg)) then 0 else open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "C")) else Concat(CurrentDOM, "C")) + AsPrice(CallStrike + strikeSpacing * 18), agg);
def callOptionopen_interest19 = if IsNaN(open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "C")) else Concat(CurrentDOM, "C")) + AsPrice(CallStrike + strikeSpacing * 19), agg)) then 0 else open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "C")) else Concat(CurrentDOM, "C")) + AsPrice(CallStrike + strikeSpacing * 19), agg);
def callOptionopen_interest20 = if IsNaN(open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "C")) else Concat(CurrentDOM, "C")) + AsPrice(CallStrike + strikeSpacing * 20), agg)) then 0 else open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "C")) else Concat(CurrentDOM, "C")) + AsPrice(CallStrike + strikeSpacing * 20), agg);

def callOptionopen_interesta = if IsNaN(open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "C")) else Concat(CurrentDOM, "C")) + AsPrice(CallStrike - strikeSpacing * 0), agg)) then 0 else open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "C")) else Concat(CurrentDOM, "C")) + AsPrice(CallStrike - strikeSpacing * 0), agg);
def callOptionopen_interest1a = if IsNaN(open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "C")) else Concat(CurrentDOM, "C")) + AsPrice(CallStrike - strikeSpacing * 1), agg)) then 0 else open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "C")) else Concat(CurrentDOM, "C")) + AsPrice(CallStrike - strikeSpacing * 1), agg);
def callOptionopen_interest2a = if IsNaN(open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "C")) else Concat(CurrentDOM, "C")) + AsPrice(CallStrike - strikeSpacing * 2), agg)) then 0 else open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "C")) else Concat(CurrentDOM, "C")) + AsPrice(CallStrike - strikeSpacing * 2), agg);
def callOptionopen_interest3a = if IsNaN(open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "C")) else Concat(CurrentDOM, "C")) + AsPrice(CallStrike - strikeSpacing * 3), agg)) then 0 else open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "C")) else Concat(CurrentDOM, "C")) + AsPrice(CallStrike - strikeSpacing * 3), agg);
def callOptionopen_interest4a = if IsNaN(open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "C")) else Concat(CurrentDOM, "C")) + AsPrice(CallStrike - strikeSpacing * 4), agg)) then 0 else open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "C")) else Concat(CurrentDOM, "C")) + AsPrice(CallStrike - strikeSpacing * 4), agg);
def callOptionopen_interest5a = if IsNaN(open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "C")) else Concat(CurrentDOM, "C")) + AsPrice(CallStrike - strikeSpacing * 5), agg)) then 0 else open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "C")) else Concat(CurrentDOM, "C")) + AsPrice(CallStrike - strikeSpacing * 5), agg);
def callOptionopen_interest6a = if IsNaN(open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "C")) else Concat(CurrentDOM, "C")) + AsPrice(CallStrike - strikeSpacing * 6), agg)) then 0 else open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "C")) else Concat(CurrentDOM, "C")) + AsPrice(CallStrike - strikeSpacing * 6), agg);
def callOptionopen_interest7a = if IsNaN(open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "C")) else Concat(CurrentDOM, "C")) + AsPrice(CallStrike - strikeSpacing * 7), agg)) then 0 else open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "C")) else Concat(CurrentDOM, "C")) + AsPrice(CallStrike - strikeSpacing * 7), agg);
def callOptionopen_interest8a = if IsNaN(open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "C")) else Concat(CurrentDOM, "C")) + AsPrice(CallStrike - strikeSpacing * 8), agg)) then 0 else open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "C")) else Concat(CurrentDOM, "C")) + AsPrice(CallStrike - strikeSpacing * 8), agg);
def callOptionopen_interest9a = if IsNaN(open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "C")) else Concat(CurrentDOM, "C")) + AsPrice(CallStrike - strikeSpacing * 9), agg)) then 0 else open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "C")) else Concat(CurrentDOM, "C")) + AsPrice(CallStrike - strikeSpacing * 9), agg);
def callOptionopen_interest10a = if IsNaN(open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "C")) else Concat(CurrentDOM, "C")) + AsPrice(CallStrike - strikeSpacing * 10), agg)) then 0 else open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "C")) else Concat(CurrentDOM, "C")) + AsPrice(CallStrike - strikeSpacing * 10), agg);
def callOptionopen_interest11a = if IsNaN(open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "C")) else Concat(CurrentDOM, "C")) + AsPrice(CallStrike - strikeSpacing * 11), agg)) then 0 else open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "C")) else Concat(CurrentDOM, "C")) + AsPrice(CallStrike - strikeSpacing * 11), agg);
def callOptionopen_interest13a = if IsNaN(open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "C")) else Concat(CurrentDOM, "C")) + AsPrice(CallStrike - strikeSpacing * 12), agg)) then 0 else open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "C")) else Concat(CurrentDOM, "C")) + AsPrice(CallStrike - strikeSpacing * 12), agg);
def callOptionopen_interest12a = if IsNaN(open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "C")) else Concat(CurrentDOM, "C")) + AsPrice(CallStrike - strikeSpacing * 13), agg)) then 0 else open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "C")) else Concat(CurrentDOM, "C")) + AsPrice(CallStrike - strikeSpacing * 13), agg);
def callOptionopen_interest14a = if IsNaN(open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "C")) else Concat(CurrentDOM, "C")) + AsPrice(CallStrike - strikeSpacing * 14), agg)) then 0 else open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "C")) else Concat(CurrentDOM, "C")) + AsPrice(CallStrike - strikeSpacing * 14), agg);
def callOptionopen_interest15a = if IsNaN(open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "C")) else Concat(CurrentDOM, "C")) + AsPrice(CallStrike - strikeSpacing * 15), agg)) then 0 else open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "C")) else Concat(CurrentDOM, "C")) + AsPrice(CallStrike - strikeSpacing * 15), agg);
def callOptionopen_interest16a = if IsNaN(open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "C")) else Concat(CurrentDOM, "C")) + AsPrice(CallStrike - strikeSpacing * 16), agg)) then 0 else open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "C")) else Concat(CurrentDOM, "C")) + AsPrice(CallStrike - strikeSpacing * 16), agg);
def callOptionopen_interest17a = if IsNaN(open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "C")) else Concat(CurrentDOM, "C")) + AsPrice(CallStrike - strikeSpacing * 17), agg)) then 0 else open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "C")) else Concat(CurrentDOM, "C")) + AsPrice(CallStrike - strikeSpacing * 17), agg);
def callOptionopen_interest18a = if IsNaN(open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "C")) else Concat(CurrentDOM, "C")) + AsPrice(CallStrike - strikeSpacing * 18), agg)) then 0 else open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "C")) else Concat(CurrentDOM, "C")) + AsPrice(CallStrike - strikeSpacing * 18), agg);
def callOptionopen_interest19a = if IsNaN(open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "C")) else Concat(CurrentDOM, "C")) + AsPrice(CallStrike - strikeSpacing * 19), agg)) then 0 else open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "C")) else Concat(CurrentDOM, "C")) + AsPrice(CallStrike - strikeSpacing * 19), agg);
def callOptionopen_interest20a = if IsNaN(open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "C")) else Concat(CurrentDOM, "C")) + AsPrice(CallStrike - strikeSpacing * 20), agg)) then 0 else open_interest("." + symbol + CurrentYear + (if CurrentMonth < 10 then Concat(0, (CurrentMonth)) else AsText(CurrentMonth)) + (if CurrentDOM < 10 then Concat(0, (CurrentDOM + "C")) else Concat(CurrentDOM, "C")) + AsPrice(CallStrike - strikeSpacing * 20), agg);
