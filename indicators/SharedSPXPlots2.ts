...
input space = .05; # the vertical space between the put open interest bar and call open interest bar.
    ...
    DefineGlobalColor("CallColor", Color.DARK_GREEN);
DefineGlobalColor("PutColor", Color.YELLOW);
...
AddLabel(yes, "Total Open Interest PUTS: " + totalPutsVol, Color.DARK_RED);
...
AddLabel(yes, "Total Open Interest Calls: " + totalCallVol, Color.DARK_GREEN);
